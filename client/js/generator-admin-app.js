...
VIEW_PRODUCT_LIST: 800,
VIEW_PRODUCT_ADD: 801,
VIEW_PRODUCT_EDIT: 802,
...
openHome() {
  ...
  loadProfile(){
    Axios.get(`${this.serverUrl}/admin/profile`, {
  ...
  checkUserToken() {
    this.accountToken = localStorage.getItem("admin_token");
  ...
  saveToken() {
    localStorage.setItem("admin_token", this.accountToken);
  },
